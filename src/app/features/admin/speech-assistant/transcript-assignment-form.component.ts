...
@Component({
  ...
  templateUrl: './transcript-assignment-form.component.html',
  styleUrls: ['./transcript-assignment-form.component.scss']
})
export class TranscriptAssignmentFormComponent implements OnInit {
  @Input() transcript!: Transcript;
  @Input() showButtons = true; // Inline mode might not need buttons
  @Output() save = new EventEmitter<Transcript>();
  ...
  async ngOnInit(): Promise<void> {
    // Initialize form with transcript data

...
const ha_import_service_1 = require("../modules/homeassistant/services/ha-import.service");
const fs = require("fs");
...
async function bootstrap() {
    ...
    const importService = app.get(ha_import_service_1.HaImportService);
    ...
    try {
        ...
        const { HaQueryService } = await Promise.resolve().then(() => require('../modules/homeassistant/services/ha-query.service'));
        ...
        if (stats.entitiesByType?.length > 0) {
            ...
            stats.entitiesByType.forEach((type) => {
...
//# sourceMappingURL=import-ha-data.js.map